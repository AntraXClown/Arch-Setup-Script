...
PACKAGES=(
  ...
  entr ristretto man-db man-pages tldr
  ##########################################################################################
  # zsh
  ##########################################################################################
  zsh zoxide the_silver_searcher yazi-git tmux tmux-plugin-manager zsh-autocomplete
  ##########################################################################################
  # Bluetooth
  ##########################################################################################
  bluez bluez-utils
  ...
  composer php github-cli python-pygobject-stubs
  ##########################################################################################
  # btrfs
  ##########################################################################################
